...
class TestDatetimeSlider:
    ...
    def test_datetime_slider_default_state(self):
        ...
        assert get_query_params(self.at)["datetime_slider"] == [self.default_date.strftime('%Y-%m-%dT%H:%M:%S')]
...
class TestDateSlider:
    ...
    def test_date_slider_default_state(self):
        ...
        assert get_query_params(self.at)["date_slider"] == [self.default_date.strftime('%Y-%m-%d')]
...
class TestTimeSlider:
    ...
    def test_time_slider_default_state(self):
        ...
        assert get_query_params(self.at)
        assert get_query_params(self.at)["time_slider"] == [self.default_time.strftime('%H:%M')]
    ...
    def test_form_slider_all_types(self):
        ...
        def multi_type_form_app():
            ...
            with form:
                ...
                date_slider = form.slider("Date Slider", 
                                        date(2024, 1, 1),
                                        date(2024, 12, 31),
                                        date(2024, 6, 15),
                                        url_key="date_slider")
