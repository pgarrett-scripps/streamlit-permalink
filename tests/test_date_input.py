...
class TestDateInput:
    ...
    def test_date_input_default_state(self):
        ...
        assert self.at.date_input[4].value == date(2024, 5, 15)  # Datetime converted to date
    ...
    def test_date_input_limits(self):
        ...
        set_query_params(self.at, {
            "limited_date": "2023-12-31"  # Before min_value of 2024-01-01
        })
        ...
        set_query_params(self.at, {
            "limited_date": "2025-01-01"  # After max_value of 2024-12-31
        })
        ...
        set_query_params(self.at, {
            "limited_date": "2024-06-01"  # Within limits
        })
        self.at.run()
        assert not self.at.exception
    ...
    def test_date_input_invalid_format(self):
        ...
        set_query_params(self.at, {
            "date": "01/01/2024"  # Wrong format, should be YYYY-MM-DD
        })
        self.at.run()
        assert self.at.exception
    ...
    def test_date_range_order_validation(self):
        ...
        set_query_params(self.at, {
            "date_range": ["2024-12-31", "2024-01-01"]  # Start after end
        })
    ...
    def test_date_range_empty_handling(self):
        ...
        set_query_params(self.at, {
            "date_range": [_EMPTY]  # Use uppercase to match constant
        })
        self.at.run()
        assert not self.at.exception
    ...
    def test_date_range_single_date_handling(self):
        ...
        set_query_params(self.at, {
            "date_range": ["2024-05-15"]  # Only start date
        })
